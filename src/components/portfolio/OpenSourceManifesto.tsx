  ...
  return (
    <section className="py-24 bg-slate-950 px-6 relative overflow-hidden">
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="inline-flex items-center gap-2 text-emerald-400 font-mono text-sm mb-8 uppercase tracking-widest">
          <Terminal size={16} />
        ...
        <div className="space-y-12">
          ...
          >
            ...
            >
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">EVERYONE.</span>
              <motion.div 
          ...
          <p className="text-xl md:text-2xl text-slate-400 font-light leading-relaxed">
            We believe that software should be accessible and inclusive. We build tools that empower founders and communities to thrive in the <span className="text-slate-200 font-medium">modern digital economy.</span>
          </p>
          ...
          <div className="flex flex-wrap gap-6 pt-8 border-t border-slate-800">
             <div className="flex items-center gap-2 text-slate-500 group cursor-pointer hover:text-white transition-colors">
                <Github size={24} />
                <span className="font-mono text-sm uppercase">Open Source</span>
             </div>
             <div className="flex items-center gap-2 text-slate-500 group cursor-pointer hover:text-pink-500 transition-colors">
                <Heart size={24} />
                <span className="font-mono text-sm uppercase">Support Us</span>
             </div>
          </div>
        </div>
      </div>
