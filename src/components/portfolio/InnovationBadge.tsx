...
const badges: Badge[] = [
  ...
  { icon: Trophy, label: "Top Innovation" },
        ...
        {badges.map((badge, idx) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-sm font-semibold tracking-widest uppercase text-slate-500 group-hover:text-white transition-colors">
                {badge.label}
              </span>
            </motion.div>
          );
